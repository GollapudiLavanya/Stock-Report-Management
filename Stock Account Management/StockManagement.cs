...
namespace StockAccountManagement
{
    class StockManagement
    {
        public void BuyStocks(Customer customerRecords)
        {
            ...
            Stocks stockAccount = JsonConvert.DeserializeObject<Stocks>(File.ReadAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\StockDetails.json"));
            ...
            if (numberOfShares <= stockName.NumberOfShares)
            {
                ...
                if (cost <= marked.Amount)
                {
                    ...
                    if (proceed == 'Y' || proceed == 'y')
                    {
                        ...
                        Transaction transaction = JsonConvert.DeserializeObject<Transaction>(File.ReadAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\TransactionDetails.json"));
                        transaction.TransactionRecordsList.Add(newObj);
                        File.WriteAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\CustomerDetails.json", JsonConvert.SerializeObject(customerRecords));
                        File.WriteAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\StockDetails.json", JsonConvert.SerializeObject(stockAccount));
                        File.WriteAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\TransactionDetails.json", JsonConvert.SerializeObject(transaction));
        ...
        public void SellStocks(Customer customerRecords)
        {
            ...
            Console.WriteLine(marked.UserName);
            Stocks stockAccount = JsonConvert.DeserializeObject<Stocks>(File.ReadAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management"));
            management.ViewStocks();
        ...
        {
            Customer customerRecords = JsonConvert.DeserializeObject<Customer>(File.ReadAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\CustomerDetails.json"));
            foreach (Customer.CustomerRecords customer in customerRecords.CustomerRecordsList)
            {
        ...
        {
            Console.WriteLine("\n  Transactions ");
            Transaction transaction = JsonConvert.DeserializeObject<Transaction>(File.ReadAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\StockDetails.json"));
