...
namespace StockAccountManagement
{
    class Stocks
    {
        StockManagement manage = JsonConvert.DeserializeObject<StockManagement>(File.ReadAllText(@"C:\Users\dell\source\repos\Stock Account Management\Stock Account Management\StockReports.json"));
